...
// -------------------------------------------------------///---//////-/-/--/-/---/--/---//-/--/-/--//--/-/--/-//-/-------/
import {
    FATSECRET_CONSUMER_KEY  as CONSUMER_KEY,
    FATSECRET_CONSUMER_SECRET as CONSUMER_SECRET,
  } from '@env';
  ...
  export async function getFoodById(foodId: string, region: string, language?: string) {
